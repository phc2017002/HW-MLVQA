...
output_file_name = 'output_responses_qwen2vl_7B_hindi_easy_ocr_only.txt'
output_file_path = os.path.join(output_directory, output_file_name)

#model = model.half()

ocr_directory = './hindi_easy_ocr_text_new'
...
def get_ocr_text_for_subdir(subdir_name, ocr_directory):
    ...
    ocr_file_name = f"ocr_text_{identifier}.txt"
    ...
    if os.path.isdir(subdir_path):
        ...
        if qa_file:
            ...
            for question in questions:
                ...
                del generated_ids, generated_ids_trimmed, inputs, text
